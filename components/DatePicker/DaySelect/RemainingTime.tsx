...
export default function RemainingTime({
  ...
  return (
    <motion.div
      ...
      className="relative w-full rounded-lg bg-white p-2 ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800"
      role="timer"
    ...
    >
      <div className="flex gap-3 sm:gap-4">
        ...
        <div className="flex animate-pulse items-center gap-2">
          <motion.div
            className="flex items-center gap-2 rounded-lg bg-slate-100 px-4 py-2 dark:bg-slate-800"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
