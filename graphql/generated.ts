...
export type GetVendorProductsWithPaginationQuery = { product_aggregate: { aggregate?: { count: number } | null }, tenant_by_pk?: { name?: string | null, logo?: string | null, created_at: any } | null, product: Array<{ id: any, description?: string | null, name: string, image_url?: Array<string> | null, price: number, quantity?: number | null, category: { name: string, slug?: string | null } }> };
