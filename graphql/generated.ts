...
export type Payment_Constraint =
  /** unique or primary key constraint on columns "id" */
  | 'payment_pkey';
...
export type Payment_Select_Column =
  /** column name */
  | 'amount'
  /** column name */
  | 'created_at'
...
export type Payment_Update_Column =
  /** column name */
  | 'amount'
  /** column name */
  | 'created_at'
