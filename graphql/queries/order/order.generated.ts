...
export type GetOrderApproveImagesQuery = {
  order_item: Array<{
    images_to_approve?: Array<string> | null;
    is_images_approved?: boolean | null;
    image_approve_expiry?: any | null;
  }>;
};
...
export type UpdateOrderItemApproveMutation = {
  update_order_item?: {
    affected_rows: number;
    returning: Array<{ is_images_approved?: boolean | null }>;
  } | null;
};
...
export type GetOrderForTrackingQuery = {
  order: Array<{
    created_at: any;
    order_no?: any | null;
    tenant_orders: Array<{
      id: any;
      status?: Types.Order_Status_Enum | null;
      order_items: Array<{
        quantity: number;
        id: any;
...
export type GetOrderByIdQuery = {
  order_by_pk?: {
    ...
    tenant_orders: Array<{
      tenant: {
        tenants: Array<{ logo?: string | null; name?: string | null }>;
      };
      order_items: Array<{
        id: any;
        status?: Types.Order_Status_Enum | null;
        ...
        quantity: number;
        order_item_special_images: Array<{
          id: any;
          image_url: string;
          order_item_id: any;
          quantity_index?: number | null;
        }>;
        order_item_special_texts: Array<{
          id: any;
          order_item_id: any;
          quantity_index?: number | null;
          content: string;
...
`;
export type GetSingleTenantOrderItemQueryResult = Apollo.QueryResult<
...
`;
export type GetOrderApproveImagesQueryResult = Apollo.QueryResult<
...
`;
export type UpdateOrderItemApproveMutationFn = Apollo.MutationFunction<
  UpdateOrderItemApproveMutation,
  UpdateOrderItemApproveMutationVariables
>;
export type UpdateOrderItemApproveMutationResult =
  Apollo.MutationResult<UpdateOrderItemApproveMutation>;
export type UpdateOrderItemApproveMutationOptions = Apollo.BaseMutationOptions<
  UpdateOrderItemApproveMutation,
  UpdateOrderItemApproveMutationVariables
>;
export const GetOrderForTrackingDocument = gql`
  query getOrderForTracking($orderNo: bigint!) {
    order(
      where: { order_no: { _eq: $orderNo }, payment_status: { _eq: PAID } }
    ) {
      created_at
      order_no
      tenant_orders {
...
`;
export type GetOrderForTrackingQueryResult = Apollo.QueryResult<
