...
export type GetUserOrdersQuery = {
  order: Array<{
    ...
    tenant_orders: Array<{
      id: any;
      tenant: { id: any; tenants: Array<{ name?: string | null; id: any }> };
      order_items: Array<{
        id: any;
...
export type UpdateOrderItemSpecialTextMutationVariables = Types.Exact<{
  object:
    | Array<Types.Order_Item_Special_Text_Insert_Input>
    | Types.Order_Item_Special_Text_Insert_Input;
}>;

export type UpdateOrderItemSpecialTextMutation = {
  insert_order_item_special_text?: { affected_rows: number } | null;
};
...
`;
export type UpdateOrderItemSpecialTextMutationFn = Apollo.MutationFunction<
  UpdateOrderItemSpecialTextMutation,
  UpdateOrderItemSpecialTextMutationVariables
>;
export type UpdateOrderItemSpecialTextMutationResult =
  Apollo.MutationResult<UpdateOrderItemSpecialTextMutation>;
export type UpdateOrderItemSpecialTextMutationOptions =
