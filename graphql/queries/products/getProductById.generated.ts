...
export type GetProductForCartQuery = {
  product?: {
    ...
    product_categories: Array<{ category: { name: string } }>;
    tenant: {
      id: any;
      tenants: Array<{
        id: any;
...
export type GetProductActionDataQuery = {
  product?: {
    delivery_type?: Types.Delivery_Type_Enum | null;
    delivery_time_ranges?: any | null;
    tenant: {
      tenants: Array<{ tenant_shipping_places: Array<{ places: any }> }>;
    };
    user_favorites_aggregate: { aggregate?: { count: number } | null };
    user_favorites: Array<{ product_id: any }>;
  } | null;
};
...
export type GetProductActionDataForAnonymousQuery = {
  product?: {
    delivery_type?: Types.Delivery_Type_Enum | null;
    delivery_time_ranges?: any | null;
    tenant: {
...
export type GetProductInformationQuery = {
  product?: {
    ...
    slug?: string | null;
    discount_price?: number | null;
    product_categories: Array<{ category: { slug?: string | null } }>;
    product_customizable_areas: Array<{
      count: number;
      max_character?: number | null;
      customizable_area: { id: number; type: string };
    ...
    reviews_aggregate: {
      aggregate?: {
        count: number;
        avg?: { score?: number | null } | null;
      } | null;
    };
    tenant: { tenants: Array<{ name?: string | null; id: any }> };
  } | null;
};
...
export type GetProductImagesQuery = {
  product?: { image_url?: Array<string> | null } | null;
};
...
export type GetProductDescriptionQuery = {
  product?: { description?: string | null; properties?: any | null } | null;
};
...
export type GetProductCommentsQuery = {
  product?: {
    reviews: Array<{
      id: number;
      comment?: string | null;
...
`;
export type GetProductForCartQueryResult = Apollo.QueryResult<
  GetProductForCartQuery,
  GetProductForCartQueryVariables
>;
...
`;
export type GetProductPricesByIdQueryResult = Apollo.QueryResult<
  GetProductPricesByIdQuery,
  GetProductPricesByIdQueryVariables
>;
...
`;
export type GetProductsForInitialCartQueryResult = Apollo.QueryResult<
...
`;
export type GetProductActionDataQueryResult = Apollo.QueryResult<
...
`;
export type GetProductActionDataForAnonymousQueryResult = Apollo.QueryResult<
...
`;
export type GetProductImagesQueryResult = Apollo.QueryResult<
...
`;
export type GetProductDescriptionQueryResult = Apollo.QueryResult<
...
`;
export type GetProductCommentsQueryResult = Apollo.QueryResult<
