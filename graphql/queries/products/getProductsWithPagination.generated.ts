...
`;
export type GetProductsWithPaginationQueryResult = Apollo.QueryResult<
...
`;
export type GetProductsWithFilteredPaginationQueryResult = Apollo.QueryResult<
