        ...
        <div className="p-8 pt-4 font-mono">
          ...
          <form className="py-4 ">
            <div className="flex items-center justify-between mb-4">
              ...
              <Tooltip
                content="Değerlendirmenizde ürünün kalitesi, teslimat hızı, satıcı ile iletişim gibi konuları değerlendirebilirsiniz. Lütfen ürün ile ilgili değerlendirme yapınız."
                position="top"
              >
                <p
