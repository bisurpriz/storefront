          ...
          <ul className="flex flex-col gap-2">
            {comments?.map((comment, index) => (
              <li
                ...
                className="flex sm:items-start justify-start border-b border-slate-100 pb-4 max-sm:flex-col max-sm:gap-2 w-full"
              ...
              >
                ...
                {comment.comment && (
                  <div className="rounded-lg h-fit bg-purple-200 w-fit font-manrope">
                    <p
                      className="text-sm text-slate-700 whitespace-pre-wrap p-4"
